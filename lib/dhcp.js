...
function dhcp() {
  ...
  function run(locationName, dhcpCheckConfig) {
    ...
    function parseOutput(output) {
      ...
      toFind.forEach(function (deviceId) {
        var isHome = this.presence[locationName].people[macToPerson[deviceId]]
          ...
          , macHandled = determineLeaving.call(this, found, isHome, lastSeen, deviceId, 'no mac found')
        ...
        if (!macHandled && found) {
          ...
          ping.sys.probe(ip, function (isAlive) {
            ...
            var ipHandled = determineLeaving.call(this, isAlive, isHome, lastSeen, deviceId, 'unreachable')
    ...
    function determineLeaving(found, isHome, lastSeen, deviceId, reason) {
      ...
      if (!found && isHome && !lastSeen) {
        ...
        return true
      } else if (!found && isHome && lastSeen && now - lastSeen >= 600000) {
